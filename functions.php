...
function add_custom_scripts()
{
    ...
    wp_enqueue_style('main-styles', get_template_directory_uri() . '/styles/main.min.css');


    wp_enqueue_script('libs', get_template_directory_uri() . '/js/main-libs.min.js', array(), '', true);
