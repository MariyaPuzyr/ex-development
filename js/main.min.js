...
$(document).ready(function () {
  ...
  $(document).on("click", ".header-menu__link, .back-link", function () {
  ...
  $(document).on("click", ".header-menu__link.active", function () {
    if($(this).hasClass('active')) {
      $(this).removeClass('active');
      $('.tab-pane, .header-menu').removeClass('active');
    }
  });
  ...
  $(document).on("click", '.xtl_submit.js_exchange_link', function () {
    ...
    // $('body').on('click', '.get-page',function(e){
    //   e.preventDefault();
    //   $('.main-menu-links').hide();
    //   $('.main-menu-partners-info').hide();
    //   $('.sidebar-page').show();
    ...
    // });
    //
    // $('body').on('click', '.sidebar-page .back-link',function(e){
    //   e.preventDefault();
    //   $('.main-menu-links').show();
    //   $('.main-menu-partners-info').show();
    //   $('.sidebar-page').hide();
    //   $(".sidebar-page").empty()
    //   return false;
    // });

    $('body').on('click', '.news-list .news-list__item--link',function(e){
      ...
      $.ajax({
        ...
        cache: false,
        success: function(data){
            $(".slider.single-item").html('');
          $(".slider.single-item").html(data);
            if ($('.slider').hasClass('slick-initialized')) {
                $('.slider').slick('unslick');
            }
            $('.slider').slick($opts);
  ...
  $('.copy-btn').click(function (e) {
    e.preventDefault();
      var temp = $("<input>");
      $("body").append(temp);
      temp.val($($('.partners-info__copy input')[0]).val()).select();
  ...
  $('body').on('input', 'input.search-reserves',function(e){
    var filter = $(this).val();
    if(filter) {
      $matches = $($('.currency-reserves__list')).find('div.currency-reserves__info:Contains(' + filter + ')').parent();
      $('div.currency-reserves__item', $('.currency-reserves__list')).not($matches).slideUp();
      $matches.slideDown();
    } else {
      $($('.currency-reserves__list')).find("div.currency-reserves__item").slideDown();
    }
    return false;
  })

    $('body').on('submit', '.currency-reserves form',function(e){
      e.preventDefault();
    })
